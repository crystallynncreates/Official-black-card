...
- **Nav doesn't reflect signed-in state globally** — pages without the Supabase client loaded always show "Log In / Join" even if the visitor is signed in elsewhere. The 13 wired pages check session state; the rest don't yet.
